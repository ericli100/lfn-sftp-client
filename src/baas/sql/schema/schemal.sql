/****** Object:  User [baasworker]    Script Date: 6/4/2022 7:43:14 AM ******/
CREATE USER [baasworker] FOR LOGIN [baasworker] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  User [bubbleio]    Script Date: 6/4/2022 7:43:14 AM ******/
...
GO
/****** Object:  Schema [baas]    Script Date: 6/4/2022 7:43:14 AM ******/
CREATE SCHEMA [baas]
GO
/****** Object:  Table [baas].[accounts]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [baas].[addresses]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[audit]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [baas].[audit](
	...
	[levelOfDetail] [smallint] NOT NULL,
	[noun] [nvarchar](50) NULL,
...
GO
/****** Object:  Table [baas].[authentication]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[changeHistory]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[entities]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[entityDescriptions]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[entityReferenceNumbers]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[entityRelationships]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[entityTypes]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[events]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[eventTypes]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [baas].[eventTypes](
	...
	[contextOrganizationId] [char](20) NOT NULL,
	[eventKey] [nvarchar](100) NOT NULL,
	[eventTrueName] [nvarchar](75) NOT NULL,
	[eventFalseName] [nvarchar](75) NOT NULL,
	[versionNumber] [bigint] NULL,
	[mutatedBy] [char](20) NULL,
	[mutatedDate] [datetime] NULL,
	[correlationId] [char](20) NULL,
...
GO
/****** Object:  Table [baas].[fileBatches]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[files]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[fileTransactions]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[fileTypes]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[hierarchies]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[journal]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[organizationAuthorization]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [baas].[organizationAuthorization](
	...
	[tenantId] [uniqueidentifier] NOT NULL,
	[contextOrganizationId] [char](20) NOT NULL,
	[authorizedOrgId] [char](20) NOT NULL,
...
GO
/****** Object:  Table [baas].[organizationIdentifiers]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [baas].[organizationIdentifiers](
	...
	[tenantId] [uniqueidentifier] NOT NULL,
	[contextOrganizationId] [char](20) NOT NULL,
	[organizationId] [char](20) NOT NULL,
...
GO
/****** Object:  Table [baas].[organizations]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [baas].[organizations](
	...
	[companyIdentification] [nchar](25) NULL,
...
GO
/****** Object:  Table [baas].[organizationTypes]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[persons]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[tenants]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[users]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [baas].[userSessions]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_WhoIsActive]    Script Date: 6/4/2022 7:43:14 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
