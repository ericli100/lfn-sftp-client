...
async function processfileReceipt({ baas, logger, CONFIG, contextOrganizationId, toOrganizationId, fromOrganizationId, correlationId }) {
    ...
    try {
        ...
        for(let accountNumber of output.accounts){
            ...
            let fileDate = date.getFullYear() + ("0" + (date.getMonth() + 1)).slice(-2) + ("0" + date.getUTCDate()).slice(-2) + ("0" + date.getUTCHours()).slice(-2) + ("0" + date.getUTCMinutes()).slice(-2) + ("0" + date.getUTCSeconds()).slice(-2)
